...
section .data
    ...
    resultMsg db 'Result: $' ; Визначення рядка для виведення результату, $ вказує на кінець рядка

section .text
_start:
    ; Обчислення за формулою b - c + a
    ...
    add al, '0'          ; Перетворюємо число в ASCII символ
